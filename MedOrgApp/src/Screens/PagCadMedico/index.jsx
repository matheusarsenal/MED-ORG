...
export default function CadastroMedico() {
  ...
  const handleSubmit = () => {
    ...
    if (!senhaValida.test(formData.senha)) {
      Alert.alert(
        "Erro",
        "A senha deve conter ao menos uma letra maiúscula e um símbolo especial."
      );
      return;
    }
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <TextInput
        ...
        onChangeText={(text) => handleChange("especializacao", text)}
      />
      <TextInput
        placeholder="CRM"
        style={styles.input}
      ...
      <TextInput
        ...
        onChangeText={(text) => handleChange("formacao", text)}
      />
      <TextInput
        placeholder="Senha"
        style={styles.input}
